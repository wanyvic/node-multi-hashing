...
Handle<Value> jumphash(const Arguments& args) {
    HandleScope scope;
    ...
    jump_hash(input, output, input_len);
...
void init(Handle<Object> exports) {
    ...
    exports->Set(String::NewSymbol("jumphash"), FunctionTemplate::New(jumphash)->GetFunction());
}
